...
html_temp = """
<div style="background-color:tomato;"><p style="color:white;font-size:40px;padding:9px">Live SBI Rewardz App Sentiment analysis</p></div>
"""
...
if st.button("Get Pie Chart for Different Sentiments"):
    ...
    c = len(df[df["Sentiment"] == "not defined"])
    d = np.array([a, b, c])
